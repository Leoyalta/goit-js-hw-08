...
// galleryList.addEventListener('click', function (evant)  {
//     console.log(evant.target);
// });

galleryList.addEventListener('click', evant => {
    if (evant.target.nodeName !== 'IMG') {
      return;
    }
  
    function handleClick(evant) {
        evant.key === 'Escape' ? instance.close() : null;
    }
